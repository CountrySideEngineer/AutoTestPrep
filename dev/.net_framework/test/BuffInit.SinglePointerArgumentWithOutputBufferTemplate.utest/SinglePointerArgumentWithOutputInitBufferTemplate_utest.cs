...
namespace BuffInit.SinglePointerArgumentWithOutputBufferTemplate.utest
{
	[TestClass]
	public class SinglePointerArgumentWithOutputInitBufferTemplate_utest
	{
		[TestMethod]
		...
		public void TransformText_utest_001()
		{
			...
			var template = new BufferInit.SinglePointerArgumentWithOutputBufferTemplate()
			{
				Target = function,
				Argument = argument,
				Rule = rule,
