...
{
	internal class FunctionBufferWithReturnValueTemplate_ctest
	{
		[OneTimeSetUp]
		...
		public void Test1()
		{
			...
			string expect = $"{"long",-16}\tSampleFunction_called_count;" + Environment.NewLine +
				$"{"int",-16}\tSampleFunction_return_value[BUFFER_SIZE_1];" + Environment.NewLine;
